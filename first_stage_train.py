...
parser.add_argument('--list_dir', type=str,
                    default='../3dunet/lists/lists_LAA', help='list dir')
...
if __name__ == "__main__":
    ...
    dataset_config = {
        'LAA': {
            'train_root_path': '../medical_dataset/LAA',
            'val_root_path': '../medical_dataset/LAA',
            'list_dir': '../lists/lists_LAA',
            'num_classes': 3,
        },
    }
    ...
    net = Net(in_channel=3, out_channel=args.num_classes, training=False).cuda()

    # train the network
    transunet = {'LAA': run_main,}
